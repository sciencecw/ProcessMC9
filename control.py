...
parser = optparse.OptionParser(usage="usage: python scan.py -s [QCD, QQCD, ModelA, ModelB] ",description="This is a script to set up and run a scan over many files in parallel")
...
for i in range(0,nbin):
  ...
  jdlfile.write("Arguments = "+name+" $(process) "+hostarea+" "+str(i)+" "+parmsfile+" "+
  hostarea2+" "+'\n')
